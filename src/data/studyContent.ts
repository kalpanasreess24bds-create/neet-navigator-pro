    ...
    subjects: [
      {
        ...
        chapters: [
          ...
          { id: "b12-17", name: "Pollination & Double Fertilisation", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-18", name: "Gametogenesis – Spermatogenesis & Oogenesis", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-19", name: "Mendelian Genetics – Mono & Dihybrid Cross", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-20", name: "Sex Determination & Sex-Linked Inheritance", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-21", name: "DNA Replication, Transcription & Translation", hasPdf: true, hasFlashcards: false, progress: 0 },
          { id: "b12-22", name: "Human Genome Project & DNA Fingerprinting", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-23", name: "Hardy-Weinberg Principle & Natural Selection", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-24", name: "Immunity – Innate & Adaptive", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-25", name: "Cancer Biology", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-26", name: "AIDS & Common Diseases", hasPdf: true, hasFlashcards: false, progress: 0 },
          { id: "b12-27", name: "rDNA Technology & PCR", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-28", name: "GM Crops & Gene Therapy", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-29", name: "Ecological Succession & Nutrient Cycling", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-30", name: "Population Interactions – Predation, Parasitism", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "b12-31", name: "Ozone Depletion & Greenhouse Effect", hasPdf: true, hasFlashcards: true, progress: 0 },
        ],
      },
      {
        id: "chem-12",
        ...
        chapters: [
          ...
          { id: "c12-17", name: "Crystal Lattice & Unit Cell", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-18", name: "Colligative Properties – Detailed", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-19", name: "Nernst Equation & Electrolysis", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-20", name: "Rate Laws & Order of Reaction", hasPdf: true, hasFlashcards: false, progress: 0 },
          { id: "c12-21", name: "Colloids & Emulsions", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-22", name: "Lanthanoids & Actinoids", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-23", name: "Werner's Theory & CFT", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-24", name: "SN1 & SN2 Reactions", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-25", name: "Named Reactions in Organic Chemistry", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "c12-26", name: "Carbohydrates, Proteins & Nucleic Acids", hasPdf: true, hasFlashcards: false, progress: 0 },
        ],
      },
      {
        id: "phy-12",
        ...
        chapters: [
          ...
          { id: "p12-15", name: "Coulomb's Law & Electric Dipole", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-16", name: "Kirchhoff's Laws & Wheatstone Bridge", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-17", name: "Biot-Savart Law & Ampere's Law", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-18", name: "Faraday's Laws of EMI", hasPdf: true, hasFlashcards: false, progress: 0 },
          { id: "p12-19", name: "LCR Circuits & Resonance", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-20", name: "Mirror & Lens Formula – Numericals", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-21", name: "Young's Double Slit & Diffraction", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-22", name: "Photoelectric Effect – Detailed", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-23", name: "Bohr Model & Hydrogen Spectrum", hasPdf: true, hasFlashcards: true, progress: 0 },
          { id: "p12-24", name: "Radioactivity & Nuclear Reactions", hasPdf: true, hasFlashcards: false, progress: 0 },
          { id: "p12-25", name: "Logic Gates & Digital Electronics", hasPdf: true, hasFlashcards: true, progress: 0 },
        ],
      },
    ],
  },
